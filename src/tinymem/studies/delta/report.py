...
from tinymem.reader.prompt import normalized_answer
from tinymem.studies.delta.data import ROOM_PAIRS, replay
...
def _reference_identity(study: Path) -> dict[str, str]:
    ...
    from tinymem.studies.delta.scoring import reference_identity
