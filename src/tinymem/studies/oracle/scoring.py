...
comparison.  The oracle state is made by :mod:`tinymem.studies.oracle.state`, then passed
...
from tinymem.studies.delta.fit import load_state_records, save_state_records, selected_episodes
...
from tinymem.studies.oracle.protocol import read_dataset, require_training_seal
from tinymem.studies.oracle import fit
from tinymem.studies.oracle.state import oracle_bits, oracle_records
