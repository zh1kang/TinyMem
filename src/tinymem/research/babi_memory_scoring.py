...
from tinymem.research.babi_memory_data import query_entity, replay_locations, story_id
from tinymem.research.babi_memory_state import (
    oracle_locations, oracle_state, packed_answer, packed_size, packed_update,
)
from tinymem.research.babi_memory_training import encode_question
...
from tinymem.research.oracle_fact_fit import freeze, load_trained
