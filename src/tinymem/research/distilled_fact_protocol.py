...
from tinymem.research.delta_fact_encoding import _cached_feature, build_feature_cache
from tinymem.research.delta_fact_fit import execution_record, load_state_records
...
def verify_training_result(study: Path, protocol: dict, index: int) -> dict:
    ...
    from tinymem.research.distilled_fact_fit import load_writer
