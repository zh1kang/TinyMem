...
from tinymem.studies.distilled.fit import train_cell
...
from tinymem.studies.distilled.report import aggregate_study
from tinymem.studies.distilled.scoring import score_cell
...
def main() -> None:
    ...
    if args.stage == "evaluate":
        from tinymem.studies.distilled.protocol import evaluation_identity
